...
// Sem autenticação nesta fase (decisão deliberada — ver README.md "Fase 2"). O
// dashboard original (Netlify) tinha login por senha compartilhada; aqui os dados
// já chegam prontos em data/<brand>.json, publicados sem proteção.
